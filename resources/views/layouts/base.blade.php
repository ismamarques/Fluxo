    ...
    <div class="container">
        ...
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <div class="col-md-12 d-flex align-items-center">
                ...
                &nbsp;
                <a href="https://github.com/ismamarques" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
                 - IIIIIIIIIII SSSSSSSSSSSSSSS  MMMMMMMMMMMMMM  AAAAAAAAAA EEEEEEEEEEE  LLLLLLLLLLLLLLLLLL :P
                </a>
            </div>
        </footer>
        {{-- RODAPÉ --}}
